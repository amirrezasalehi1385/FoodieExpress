...
//                handleOnlinePayment(exchange, userId);
//            } else {
...
//
//
//    private void handleOnlinePayment(HttpExchange exchange, String userId) throws IOException {
//        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
//            String requestBody = readRequestBody(exchange);
//            Map<String, Object> paymentData = objectMapper.readValue(requestBody, Map.class);
//
//            String orderIdStr = (String) paymentData.get("orderId");
//            String method = (String) paymentData.get("method");
//            if (orderIdStr == null || method == null || !List.of("wallet", "paywall").contains(method.toLowerCase())) {
//                sendResponse(exchange, 400, "{\"error\":\"Invalid input: orderId and method (wallet/paywall) are required\"}");
//                return;
//            }
//
//            Long orderId;
...
//                sendResponse(exchange, 403, "{\"error\":\"You can only pay for your own orders\"}");
//                return;
//            }
//
//            if (order.getPaymentStatus() != null && order.getPaymentStatus().equals("PAID")) {
//                sendResponse(exchange, 400, "{\"error\":\"Order already paid\"}");
//                return;
//            }
//
...
//                    session.update(user);
//                } else {
//                    // TODO: Implement paywall integration
//                    throw new UnsupportedOperationException("Paywall payment not implemented");
//                }
//
...
//                sendResponse(exchange, 500, "{\"error\":\"Failed to process payment: " + e.getMessage() + "\"}");
//                return;
//            }
//
